...
from pymic.layer.buildingblocks import DoubleConv, ExtResNetBlock, create_encoders, \
    create_decoders
from pymic.net3d.utils import number_of_features_per_level, get_class
...
class UNet3D(Abstract3DUNet):
    ...
    def __init__(self, in_channels=1, out_channels=2, final_sigmoid=True, f_maps=64, layer_order='gcr',
...
class ResidualUNet3D(Abstract3DUNet):
    ...
    def __init__(self, in_channels=1, out_channels=2, final_sigmoid=True, f_maps=32, layer_order='gcr',
