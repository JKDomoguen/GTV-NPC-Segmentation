...
def get_segmented_body1(img, window_max=250, window_min=-150, window_length=0, show_body=False, znumber=0):
    ...
    '''
    Step 6: Keep the labels with the largest area.
    '''
    ...
    '''
    Step 7: Fill in the small holes inside the binary mask .
    '''
...
if __name__ == '__main__':
    ...
    labelroot = '../../../Dataset_Rad/liver-tumor/ct_masks'
    imgroot = '../../../Dataset_Rad/liver-tumor/ct_scans'

    saveroot_small = '../../../dataset-radiology/liver-tumor/small'
    smalldatanewroot = saveroot_small+'data'
    smalllabelnewroot = saveroot_small+'label'

    saveroot_middle = '../../../dataset-radiology/liver-tumor/middle'
    middledatanewroot = saveroot_middle+'data'
    middlelabelnewroot = saveroot_middle+'label'

    saveroot_large = '../../../dataset-radiology/liver-tumor/large'
    ...
    for imgname in os.listdir(imgroot):
        ...
        '''
        labelname = imgname.replace('volume', 'segmentation')
